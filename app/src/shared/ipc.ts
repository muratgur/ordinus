export const ipcChannels = {
  ...
  agentsAssignLibrarySkill: 'agents:assign-library-skill',
  agentsDraftSkill: 'agents:draft-skill',
  skillsListLibrary: 'skills:list-library',
  skillsGetLibrarySkill: 'skills:get-library-skill',
  skillsScanLocal: 'skills:scan-local',
  skillsSelectImportFolder: 'skills:select-import-folder',
  skillsPreviewImport: 'skills:preview-import',
  ...
  departmentsRename: 'departments:rename',
  departmentsDelete: 'departments:delete',
  departmentsReorder: 'departments:reorder',
  conversationsList: 'conversations:list',
  conversationsListAgentRoomSummaries: 'conversations:list-agent-room-summaries',
  conversationsListAgentRooms: 'conversations:list-agent-rooms',
  conversationsGet: 'conversations:get',
  conversationsCreateRoom: 'conversations:create-room',
